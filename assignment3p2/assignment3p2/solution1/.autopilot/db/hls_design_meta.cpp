...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("c", 8, hls_in, 3, "ap_none", "in_data", 1),
	Port_Property("out_r_address0", 2, hls_out, 4, "ap_memory", "mem_address", 1),
...
const char* HLS_Design_Meta::dut_name = "assignment3p2";
